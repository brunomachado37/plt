...
#define WAITING_PLAYERS_MSG                 "Waiting for players to connect"
#define START_MSG                           "All players have connected, starting match"
...
#define WELCOME_3_MSG                       "! The match will start soon."
